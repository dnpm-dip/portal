            ...
            '@authup/client-web-nuxt', 
{
    ...
    runtimeConfig: {
        ...
        public: {
            ...
            // sessions, applications), served under `/console/account` on the
            // IdP origin as of v1.0.0-beta.64. The portal has no settings area
            // of its own and links here instead. Empty falls back to
            // `<authupUrl>/console/account` at the call site; override per deployment
